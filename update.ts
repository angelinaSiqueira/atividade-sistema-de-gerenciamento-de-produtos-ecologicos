import {ProdutoLimpezaBiodegradavel} from "./ProdutoLimpezaBiodegradavel.ts";
import {AlimentoOrganico} from "./AlimentoOrganico.ts";
import {ItemDecoracaoSustentavel} from "./ItemDecoracaoSustentavel.ts";
